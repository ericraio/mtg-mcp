...
public struct LandDetectionService {
    ...
    private static func isLandByPattern(_ cardName: String) -> Bool {
        ...
        let dualPatterns = ["temple of", "sacred foundry", "steam vents", "overgrown tomb",
    ...
    public static func getLandCategory(_ cardName: String) -> LandCategory {
        ...
        let shockLands = ["Sacred Foundry", "Steam Vents", "Overgrown Tomb", "Watery Grave", 
    ...
    private static func isFetchLand(_ cardName: String) -> Bool {
        let fetchLands = ["Arid Mesa", "Bloodstained Mire", "Flooded Strand", "Marsh Flats",
    ...
    private static func isUtilityLand(_ cardName: String) -> Bool {
        let utilityLands = ["Ancient Tomb", "Strip Mine", "Wasteland", "Cabal Coffers", "Urborg",
